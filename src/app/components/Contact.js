    ...
    return (
      <section id="contact" className="py-16 bg-secondary text-text-color">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-8" style={{ textShadow: 'var(--neon-glow)' }}>Get in Touch</h2>
          ...
          <form className="space-y-4">
            ...
            <button className="px-6 py-3 bg-primary-color text-secondary font-bold rounded-full">Send Message</button>
          </form>
        </div>
      </section>
    );
